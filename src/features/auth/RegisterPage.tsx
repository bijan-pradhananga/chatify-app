    ...
    <div className="min-h-screen flex flex-col bg-background overflow-x-hidden">
      ...
      <main className="flex-grow flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-surface-container-low via-background to-secondary-fixed/30 px-4 py-8">
        ...
        <div className="w-full max-w-[440px] z-10">
          <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-xl shadow-[0px_12px_32px_rgba(0,0,0,0.06)] p-8">
            <div className="mb-6 text-center">
              <h1 className="text-headline-lg text-on-background mb-1">Create Account</h1>
              <p className="text-body-md text-on-surface-variant">Join Chatify for seamless communication.</p>
            </div>
            ...
            <Button variant="outline" className="w-full gap-2 border-outline-variant/50 rounded-lg h-10 mb-6">
