...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface dark:bg-gray-900 overflow-x-hidden" style={{ background: 'radial-gradient(circle at top right, #dbe1ff 0%, #faf8ff 50%, #eef0ff 100%)' }}>
      <AppHeader />
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md rounded-xl shadow-[0_12px_32px_rgba(0,0,0,0.08)] dark:!bg-gray-800/90 dark:border-gray-700 border border-white/50 p-8 flex flex-col gap-6 "
          ...
          <div className="text-center flex flex-col gap-1">
            ...
            <h1 className="text-headline-lg text-on-surface dark:text-gray-100">Welcome Back</h1>
            <p className="text-body-md text-on-surface-variant dark:text-gray-400">Please enter your details to sign in</p>
          </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-surface-container-low dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600 border-transparent focus-visible:border-primary focus-visible:ring-1 focus-visible:ring-primary rounded-lg"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  placeholder="••••••••"
                  className="pl-10 pr-10 bg-surface-container-low dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600 border-transparent focus-visible:border-primary focus-visible:ring-1 focus-visible:ring-primary rounded-lg"
                />
          ...
          {/* Google */}
          <Button variant="outline" onClick={handleGoogleSignIn} className="w-full gap-2 border-outline-variant rounded-lg h-10">
          ...
          <p className="text-center text-body-md text-on-surface-variant dark:text-gray-400">
